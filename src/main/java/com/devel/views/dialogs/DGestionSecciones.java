...
import com.devel.utilities.TablecellRendered.SeccionesCellRendered;
...
public class DGestionSecciones extends JDialog {
    ...
    private SeccionesAbstractModel seccionesAbstractModel;
    ...
    private void cargarTabla() {
        seccionesAbstractModel = new SeccionesAbstractModel(VPrincipal.secciones);
        tablaSecciones.setModel(seccionesAbstractModel);
        tablaSecciones.getColumnModel().getColumn(seccionesAbstractModel.getColumnCount() - 1).setCellEditor(new JButtonEditorSecciones(tablaSecciones));
        ...
        SeccionesCellRendered.setCellRenderer(tablaSecciones);
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        tablaSecciones = new JTable();
        tablaSecciones.setRowHeight(25);
        scrollPane1.setViewportView(tablaSecciones);
